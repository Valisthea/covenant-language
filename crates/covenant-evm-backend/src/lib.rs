...
pub mod codes {
    pub use crate::diag::{
        ...
        E521_TEXT_CONSTANT_TOO_LONG, E522_NESTED_MAP_UNSUPPORTED, W501_LARGE_MEMORY,
        W502_LARGE_STORAGE, W503_SELECTOR_NEAR_COLLISION, W504_LARGE_RUNTIME, W505_EVENT_NO_INDEX,
        W506_MANY_PARAMS, W507_DYNAMIC_RETURN_NOT_ENCODED, W508_ONLY_CALLER_NOOP,
    };
}
